...
echo "Uploading files for jenkins and static website..."
...
echo "Jenkins is now being provisioned!"
echo "To access your Jenkins shell, run \"ssh admin@the.ip.in.output\""
echo "ssh in and tail the provisioning script"
echo "tail -f /var/log/user-data.log"
echo "Access Jenkins GUI, with \"the.ip.in.output:8080\" in the web browser."
